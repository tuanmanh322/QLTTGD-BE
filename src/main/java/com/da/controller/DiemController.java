...
public class DiemController {
    ...
    @PostMapping("/add")
    public ResponseEntity<Void> add(@RequestBody DiemDTO dto) throws ResultException {
    ...
    @PutMapping("/edit")
    public ResponseEntity<Void> edit(@RequestBody DiemDTO dto) throws ResultException {
