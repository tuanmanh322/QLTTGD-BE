package com.da.security.jwt;

import com.da.model.The;
import com.da.security.UserDetails;
...
public class TokenProvider implements InitializingBean {
    ...
    public String createToken(Authentication authentication, boolean rememberMe) throws JsonProcessingException {
        ...
        return Jwts.builder()
                ...
                .claim(USER_DETAILS, objectMapper.writeValueAsString(userDetailsDTO.getThe()))
    ...
    public Authentication getAuthentication(String token) throws IOException {
        ...
        The principal = objectMapper.readValue(claims.get(USER_DETAILS).toString(), The.class);
